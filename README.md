...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=00c6ff,0072ff&height=200&section=header&text=Oncology&fontSize=70&fontColor=ffffff&animation=twinkling" width="100%" />
...
**Oncology** is a classification app scaffold: it trains a scikit-learn/XGBoost model on a
...
```cmd
git clone https://github.com/AfnanSharif/Oncology.git
cd Oncology
